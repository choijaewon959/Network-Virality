...
"" ""
PENS
"susceptible" 1.0 0 -13345367 true "" "plot (count turtles with [not shared? and not notshared?]) / (count turtles) * 100"
"shared" 1.0 0 -2674135 true "" "plot (count turtles with [shared?]) / (count turtles) * 100"
"Have seen" 1.0 0 -13840069 true "" "plot (count turtles with [notshared?]) / (count turtles) * 100"
